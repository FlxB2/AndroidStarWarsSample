...
import dev.swapi.client.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "dev.swapi.client.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://swapi.dev/api")
        }
    }
}
